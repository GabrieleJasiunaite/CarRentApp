...
const PrivacyPolicy = () => {
    return (
        <div className="container privacy-policy">
            ...
            <p>Šioje VCF privatumo politikoje aprašoma, kokią informaciją renkame ir kaip ją naudojame.</p>
            <ol>
                <li>Kokią informaciją mes renkame?</li>
                ...
                <li>Jūsų asmeninių duomenų naudojimas</li>
                ...
                <li>Trečiųjų šalių interneto svetainės</li>
